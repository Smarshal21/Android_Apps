...
public abstract class Hilt_MainFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainFragment_GeneratedInjector) this.generatedComponent()).injectMainFragment(UnsafeCasts.<MainFragment>unsafeCast(this));
    }
  }
