...
public abstract class Hilt_NoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoteFragment_GeneratedInjector) this.generatedComponent()).injectNoteFragment(UnsafeCasts.<NoteFragment>unsafeCast(this));
    }
  }
